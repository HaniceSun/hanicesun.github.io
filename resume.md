...
After reproducing the state-of-the-art model in splice site prediction, SpliceAI, using both TensorFlow and PyTorch, I developed new models with attention, transformer, and GPT backbone to predict tissue-specific splicing from long reads sequencing (Pac-Bio) of pancreas. I have also developed models for ancestry (machine learning) and selenocysteine element (deep learning) prediction.
