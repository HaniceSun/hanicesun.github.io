...
- Machine Learning (scikit-learn: linear model, generalized linear model, Random Forrest, SVM, etc.) and Deep Learning (PyTorch and Tensorflow: CNN, ResNet, Transformer, GPT, etc.)
